import 'package:chat_firebase_s4/workout/camera.dart';
import 'package:chat_firebase_s4/workout/render_data_yoga.dart';
...
class _PushedPageYState extends State<PushedPageY> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Warrior Pose',   style: TextStyle(
