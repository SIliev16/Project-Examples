...
class _RenderDataArmPressState extends State<RenderDataArmPress> {
  ...
  // Declarations for positions
  Vector leftEyePos = Vector(0, 0);
  Vector rightEyePos = Vector(0, 0);
  Vector leftShoulderPos = Vector(0, 0);
  Vector rightShoulderPos = Vector(0, 0);
  Vector leftElbowPos = Vector(0, 0);
  Vector rightElbowPos = Vector(0, 0);
  Vector leftWristPos = Vector(0, 0);
  Vector rightWristPos = Vector(0, 0);
  Vector leftHipPos = Vector(0, 0);
  Vector rightHipPos = Vector(0, 0);
  Vector leftKneePos = Vector(0, 0);
  Vector rightKneePos = Vector(0, 0);
  Vector leftAnklePos = Vector(0, 0);
  Vector rightAnklePos = Vector(0, 0);

  @override
  void initState() {
    super.initState();
    correctColor = Colors.red; // Provide an initial color
    squatUp = true; // Provide an initial value for squatUp
  }
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (excercise == 'arm_press' && squatUp != null) {
      if (squatUp!) {
        return wristLX != null &&
            elbowLX != null &&
            wristRX != null &&
  ...
  Future<void> _countingLogic(Map<String, List<double>>? poses) async {
    if (poses != null) {
      ...
      if (isCorrectPosture != null && squatUp != null && midCount != null && isCorrectPosture! && squatUp! && midCount! == false) {
      ...
      // back up
      if (midCount != null && isCorrectPosture != null && midCount! && isCorrectPosture!) {
        incrementCounter();
        midCount = false;
        squatUp = !squatUp!;
        setState(() {
